...
with (app.app_context()):
    ...
    try:
        ...
        hr_pa_role = Role.query.filter_by(role_need='hr_pa', action_need=None, resource_id=None).first()
    ...
    hr_pa = Permission() if not hr_pa_role else Permission(hr_pa_role.to_tuple())
